// Generated from gas_backup/payment. Do not edit directly.
...
const SettingsManager = {
  ...
  getCurrentSettings() {
    if (typeof CentralMaster !== "undefined" && typeof CentralContext !== "undefined") {
      const centralConfig = CentralMaster.getRegionConfig(CentralContext.getRegion());
      return {
...
const BusinessLogic = {
  ...
  convertPeriodOrderInBackground(runId) {
    ...
    const period = CentralContext.getPeriod();
...
const RefundDataProcessor = {
  ...
  const sheet = CentralContext.getSpreadsheet().getSheetByName("範本");
  ...
  getConfiguration_() {
    ...
    return {
      period,
      folder: folders.next(),
      targetSheet: CentralContext.getSpreadsheet().getSheetByName("範本")
    };
  },
...
function api_checkEnvironment() {
  ...
  try {
    if (!CentralContext.getSpreadsheet()) {
...
function api_pollBusStatus(runId) {
  ...
  return {
    api_checkEnvironment: api_checkEnvironment,
    api_checkScheduleStatus: api_checkScheduleStatus,
    api_detectCurrentPeriod: api_detectCurrentPeriod,
    api_diagnoseSystem: api_diagnoseSystem,
    api_getCurrentSettings: api_getCurrentSettings,
    api_getScheduleSettings: api_getScheduleSettings,
    api_initializeSystem: api_initializeSystem,
    api_pollBusStatus: api_pollBusStatus,
    api_runScheduleNow: api_runScheduleNow,
    api_setSchedule: api_setSchedule,
    api_startTask: api_startTask,
    api_testTemplateProcessing: api_testTemplateProcessing,
    appendToBus_: appendToBus_,
    checkAndRunSchedule_: checkAndRunSchedule_,
    cleanupTriggersByHandler_: cleanupTriggersByHandler_,
    clearAllTriggers: clearAllTriggers,
    dailyScheduleCheck: dailyScheduleCheck,
    doGet: doGet,
    enqueueScheduledPeriodCreation_: enqueueScheduledPeriodCreation_,
    ensureScheduleHealth_: ensureScheduleHealth_,
    finishBus_: finishBus_,
    formatDateToSlash_: formatDateToSlash_,
    getExecutionLabelFromFilename_: getExecutionLabelFromFilename_,
    hourlyScheduleCheck: hourlyScheduleCheck,
    initializeSystem: initializeSystem,
    normalizeDateOnly_: normalizeDateOnly_,
    normalizeRowDates_: normalizeRowDates_,
    normalizeSafeColumns_: normalizeSafeColumns_,
    normalizeSelectedColumnsOnly_: normalizeSelectedColumnsOnly_,
    onOpen: onOpen,
    pollBusStatus: pollBusStatus,
    preparePasteRow_: preparePasteRow_,
    saveBaseSettings: saveBaseSettings,
    saveLineSettings: saveLineSettings,
    showSidebar: showSidebar,
    startBus_: startBus_,
    startTask: startTask,
    toDateStringIfNeeded_: toDateStringIfNeeded_,
    workerDispatcher: workerDispatcher,
    writeCleanIncomeExecutionLog_: writeCleanIncomeExecutionLog_
  };
})();

function payment_api_checkEnvironment() { return PaymentApp.api_checkEnvironment.apply(null, arguments); }
function payment_api_checkScheduleStatus() { return PaymentApp.api_checkScheduleStatus.apply(null, arguments); }
function payment_api_detectCurrentPeriod() { return PaymentApp.api_detectCurrentPeriod.apply(null, arguments); }
function payment_api_diagnoseSystem() { return PaymentApp.api_diagnoseSystem.apply(null, arguments); }
function payment_api_getCurrentSettings() { return PaymentApp.api_getCurrentSettings.apply(null, arguments); }
function payment_api_getScheduleSettings() { return PaymentApp.api_getScheduleSettings.apply(null, arguments); }
function payment_api_initializeSystem() { return PaymentApp.api_initializeSystem.apply(null, arguments); }
function payment_api_pollBusStatus() { return PaymentApp.api_pollBusStatus.apply(null, arguments); }
function payment_api_runScheduleNow() { return PaymentApp.api_runScheduleNow.apply(null, arguments); }
function payment_api_setSchedule() { return PaymentApp.api_setSchedule.apply(null, arguments); }
function payment_api_startTask() { return PaymentApp.api_startTask.apply(null, arguments); }
function payment_api_testTemplateProcessing() { return PaymentApp.api_testTemplateProcessing.apply(null, arguments); }
function payment_appendToBus_() { return PaymentApp.appendToBus_.apply(null, arguments); }
function payment_checkAndRunSchedule_() { return PaymentApp.checkAndRunSchedule_.apply(null, arguments); }
function payment_cleanupTriggersByHandler_() { return PaymentApp.cleanupTriggersByHandler_.apply(null, arguments); }
function payment_clearAllTriggers() { return PaymentApp.clearAllTriggers.apply(null, arguments); }
function payment_dailyScheduleCheck() { return PaymentApp.dailyScheduleCheck.apply(null, arguments); }
function payment_enqueueScheduledPeriodCreation_() { return PaymentApp.enqueueScheduledPeriodCreation_.apply(null, arguments); }
function payment_ensureScheduleHealth_() { return PaymentApp.ensureScheduleHealth_.apply(null, arguments); }
function payment_finishBus_() { return PaymentApp.finishBus_.apply(null, arguments); }
function payment_formatDateToSlash_() { return PaymentApp.formatDateToSlash_.apply(null, arguments); }
function payment_getExecutionLabelFromFilename_() { return PaymentApp.getExecutionLabelFromFilename_.apply(null, arguments); }
function payment_hourlyScheduleCheck() { return PaymentApp.hourlyScheduleCheck.apply(null, arguments); }
function payment_initializeSystem() { return PaymentApp.initializeSystem.apply(null, arguments); }
function payment_normalizeDateOnly_() { return PaymentApp.normalizeDateOnly_.apply(null, arguments); }
function payment_normalizeRowDates_() { return PaymentApp.normalizeRowDates_.apply(null, arguments); }
function payment_normalizeSafeColumns_() { return PaymentApp.normalizeSafeColumns_.apply(null, arguments); }
function payment_normalizeSelectedColumnsOnly_() { return PaymentApp.normalizeSelectedColumnsOnly_.apply(null, arguments); }
function payment_pollBusStatus() { return PaymentApp.pollBusStatus.apply(null, arguments); }
function payment_preparePasteRow_() { return PaymentApp.preparePasteRow_.apply(null, arguments); }
function payment_saveBaseSettings() { return PaymentApp.saveBaseSettings.apply(null, arguments); }
function payment_saveLineSettings() { return PaymentApp.saveLineSettings.apply(null, arguments); }
function payment_startBus_() { return PaymentApp.startBus_.apply(null, arguments); }
function payment_startTask() { return PaymentApp.startTask.apply(null, arguments); }
function payment_toDateStringIfNeeded_() { return PaymentApp.toDateStringIfNeeded_.apply(null, arguments); }
function payment_workerDispatcher() { return PaymentApp.workerDispatcher.apply(null, arguments); }
function payment_writeCleanIncomeExecutionLog_() { return PaymentApp.writeCleanIncomeExecutionLog_.apply(null, arguments); }
